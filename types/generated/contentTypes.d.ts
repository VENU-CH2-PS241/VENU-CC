...
export interface ApiNews1News1 extends Schema.CollectionType {
  ...
  attributes: {
    id_news2: Attribute.BigInteger & Attribute.Unique;
    news_headline1: Attribute.String;
    news_headline2: Attribute.String;
    ...
    >;
    news_id_news2: Attribute.Relation<
      'api::news1.news1',
      'oneToMany',
      'api::recommendation.recommendation'
    >;
